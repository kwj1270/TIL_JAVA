...
## 커스텀 어노테이션 프로세서 만들기     
우선 해당 내용은 [ncucu님의 블로그](https://ncucu.me/155)의 내용을 팔로우하고 있습니다.      
   
기존에 어노테이션 프로세서 말고 커스텀 어노테이션 프로세서를 만들어 사용하겠다.     
`Magic` 어노테이션을 이용한 MagicMoja 클래스를 통해 Moja 클래스를 생성해보겠다.     
