...
enum Operation {
    ...
    public double apply(double x, double y) {
        switch(this) {
            case ADDITION: return x + y; break;
            case SUBTRACTION: return x - y; break;
            case MULTIPLICATION: return x * y; break;
...
public enum Direction {
    ...
    public abstract Direction getOppositeDirection();	// 추상메서드 선언
