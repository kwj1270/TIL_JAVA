...
[4. RuntimeException과 Exception 클래스의 차이](#runtimeexception과-exception-클래스의-차이)       
...
# RuntimeException과 Exception 클래스의 차이       
...
참고로, `catch 구문`에서 프로그램의 종료를 막지 않아도 JVM에서는 예외 처리가 된 것으로 간주한다.      
